...
int main()
{
	...
	*/
    ...
    y[(i + 8)] = a1 * x1[(i + 8)] * a2 * x2[(i + 8)] - a3 * x3[(i + 8)];
    y[(i + 9)] = a1 * x1[(i + 9)] * a2 * x2[(i + 9)] - a3 * x3[(i + 9)];
    y[(i + 10)] = a1 * x1[(i + 10)] * a2 * x2[(i + 10)] - a3 * x3[(i + 10)];
    y[(i + 11)] = a1 * x1[(i + 11)] * a2 * x2[(i + 11)] - a3 * x3[(i + 11)];
    y[(i + 12)] = a1 * x1[(i + 12)] * a2 * x2[(i + 12)] - a3 * x3[(i + 12)];
    y[(i + 13)] = a1 * x1[(i + 13)] * a2 * x2[(i + 13)] - a3 * x3[(i + 13)];
    y[(i + 14)] = a1 * x1[(i + 14)] * a2 * x2[(i + 14)] - a3 * x3[(i + 14)];
    y[(i + 15)] = a1 * x1[(i + 15)] * a2 * x2[(i + 15)] - a3 * x3[(i + 15)];
    y[(i + 16)] = a1 * x1[(i + 16)] * a2 * x2[(i + 16)] - a3 * x3[(i + 16)];
    y[(i + 17)] = a1 * x1[(i + 17)] * a2 * x2[(i + 17)] - a3 * x3[(i + 17)];
  }
